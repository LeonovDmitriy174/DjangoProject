...
class Blog(models.Model):
    ...
    content = models.TextField(verbose_name="Содержание", help_text="Введите содержание")
    ...
    is_published = BooleanField(verbose_name="Опубликовано", help_text="Признак публикации", default=True)
